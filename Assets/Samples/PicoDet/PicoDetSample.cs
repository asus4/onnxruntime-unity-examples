...
public class PicoDetSample : MonoBehaviour
{
    ...
    private void UpdateDetectionBox(ReadOnlySpan<PicoDet.Detection> detections)
    {
        ...
        for (i = 0; i < length; i++)
        {
            ...
            // The detection rect is model space; convert to viewport.
